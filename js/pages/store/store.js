import { bodyInterface, interfaceActive, moveFigure } from "./body-interface.js";
import { findParam, setParams } from "../../utils/url-params.js";
import { openProductOverview } from "./grid-product-overview.js";
import { addListener, selectElement, modifyClassNames } from "../../utils/manage-elements.js";
...
async function store() {
    try {
        ...
        selectElement(".main-container").insertAdjacentElement("afterbegin", icons(data))  
